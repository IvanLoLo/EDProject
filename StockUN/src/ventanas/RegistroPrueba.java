 ...
 * @author Diego
 */
public class RegistroPrueba extends javax.swing.JDialog {

    /**
     * Creates new form RegistroPrueba
     */
    public RegistroPrueba(java.awt.Frame parent, boolean modal, String name) {
        super(parent, modal);
        initComponents();
        setResizable(false);   
        this.setTitle(name);
    ...
    private void initComponents() {
        ...
        getContentPane().add(Contrasenia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 210, 230, 30));
        ...
        Contrasenia2.setBackground(new java.awt.Color(0, 0, 0, 150));
        Contrasenia2.setForeground(new java.awt.Color(255, 255, 255));
        Contrasenia2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Contrasenia2ActionPerformed(evt);
            }
        });
        getContentPane().add(Contrasenia2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 230, 30));
    ...
    private void PermisosActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    }                                        

    private void jTextFieldUsuario7ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    private void jTextFieldUsuario2ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    private void Contrasenia1ActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void jTextFieldUsuario1ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  

    private void jTextFieldUsuario5ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        // TODO add your handling code here:
    }                                                  
